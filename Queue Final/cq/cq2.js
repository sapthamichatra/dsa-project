...
push.addEventListener("click", () => {
	...
	if (stack.length == 5||front==rear+1) {
		input.value = "";
...
pop.addEventListener("click", () => {
	...
	//adding the popping animation
	bucket.firstElementChild.classList.add("ele1-remove");
	...
	//adding the popping animation
	bucket.firstElementChild.classList.add("ele2-remove");
	...
	//adding the popping animation
	bucket.firstElementChild.classList.add("ele3-remove");
	...
	//adding the popping animation
	bucket.firstElementChild.classList.add("ele4-remove");
