...
var item_elements=document.querySelectorAll(".item");
	...
	document.getElementById("singly13").style.display="block";
	...
	document.getElementById("singly14").style.display="none";
...
for(var i=0;i<li_elements.length;i++)
	li_elements[i].addEventListener("click",function(){
		...
		else if(li_value=="singlydelele"){
			document.querySelector("."+li_value).style.display="block";
		}
		else if(li_value=="singlybeg1"){
			document.querySelector("."+li_value).style.display="block";
		}
		...
		else if(li_value=="singlydelele1"){
			document.querySelector("."+li_value).style.display="block";
		}
		else{
			console.log("");
...
function linked()
{
	...
	document.getElementById("singly14").style.display="block";
	document.getElementById("singly13").style.display="none";
